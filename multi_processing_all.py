...
if __name__ == '__main__':
    ...
    for file in glob.glob("E:/data/coepelduynen/202[0|1]0[3:9]*ndvi_height.tif"):
        ...
        tif_kernel_generator.predict_all_output_multiprocessing(watlerleiding_duinen_ahn_ndvi_model,"E:/output/Coepelduynen_segmentations/"+file.split("/")[-1].replace(".tif",".shp"), steps = 3, fade = False)